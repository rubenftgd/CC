...
RT_MODEL_sanity_check_T *sanity_check(void)
{
  ...
  rtmSetTFinal(sanity_check_M, 20.0);
  sanity_check_M->Timing.stepSize0 = 0.02;

  /* External mode info */
  sanity_check_M->Sizes.checksums[0] = (2638754544U);
  sanity_check_M->Sizes.checksums[1] = (2892044440U);
  sanity_check_M->Sizes.checksums[2] = (1584121283U);
  sanity_check_M->Sizes.checksums[3] = (3674671609U);
