...
MODEL                := sanity_check
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sanity_check_data.c 
MAKEFILE             := sanity_check.mk
...
#
MODELLIB                  := sanity_checklib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sanity_check_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/CCOMP_15-11_02-04/PARTE2/sanity_check_sldrt_win32;E:/CCOMP_15-11_02-04/PARTE2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
