...
MODEL                := lab3_real_integrator
MODULES              := lab3_real_integrator_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := lab3_real_integrator.mk
...
#
MODELLIB                  := lab3_real_integratorlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := lab3_real_integrator_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/CC_PARTE3_apos_sessao2/lab3_real_integrator_sldrt_win32;E:/CC_PARTE3_apos_sessao2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
